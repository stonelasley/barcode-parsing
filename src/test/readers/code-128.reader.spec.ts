...
describe('Code128Reader', () => {
	...
	describe('validate', () => {
		...
		it('should validate identifier is prefixed', () => {
			...
			expect(classUnderTest.validate(']]C0')).to.be.false;
			expect(classUnderTest.validate(']C0A')).to.be.true;
			expect(classUnderTest.validate(']C0111111111111111111111111')).to.be.true;
			/* tslint:enable */
		});
