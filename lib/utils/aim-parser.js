    ...
    AimParser.parseAimCode = function (symbology, value) {
        switch (symbology) {
            case symbologies_1.Symbologies.GTIN8:
                return value.replace(aim_codes_1.AIM_CODES.GTIN, '');
            ...
            case symbologies_1.Symbologies.ITF8:
                return value.replace(aim_codes_1.AIM_CODES.ITF, '');
            ...
            case symbologies_1.Symbologies.GS1128:
                return value.replace(aim_codes_1.AIM_CODES.GS1, '');
            case symbologies_1.Symbologies.Code39:
                return value.replace(aim_codes_1.AIM_CODES.CODE39, '');
            default:
                return value;
        }
    };
